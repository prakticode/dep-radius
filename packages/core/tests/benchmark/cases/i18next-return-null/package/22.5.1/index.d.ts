 ...
 */
export type TOptions<TInterpolationMap extends object = StringMap> =
...
export type KeysWithSeparator<
  K1,
  K2,
  S extends string = TypeOptions["keySeparator"],
> = `${K1 & string}${S}${K2 & string}`
...
export type KeyPrefix<N extends Namespace> =
  (N extends keyof Resources ? Normalize<Resources[N]> : string) | undefined
...
export type DefaultTFuncReturn =
  string | (TypeOptions["returnNull"] extends true ? null : never)

export type DefaultTFuncReturnWithObject =
  DefaultTFuncReturn | object | Array<string | object>
...
> {
  ...
  <
    ...
    TDefaultResult extends DefaultTFuncReturn = string,
    TInterpolationMap extends object = StringMap,
    PassedNS extends Namespace = N extends string
      ? N
      : N extends unknown
        ? DefaultNamespace
        : N,
  ...
  <
    TKeys extends (
      TFuncKey<ActualNS, TKPrefix> | TemplateStringsArray extends infer A
      ? A
      : never),
    TDefaultResult extends DefaultTFuncReturnWithObject = object,
    TInterpolationMap extends object = StringMap,
