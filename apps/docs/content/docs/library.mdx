...
The CLI and the GitHub Action are thin shells around one library, `@dep-radius/core`. If you're
building your own integration (a bot, a dashboard, an MCP server), you can call it directly.
...
<Callout type="warn" title="0.x: the JSON is the stable part">
  ...
  [JSON brief](/docs/json) is the contract that doesn't. If you only need the result, running
