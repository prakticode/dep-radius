...
| Option                  | What                                                                                     |
| ----------------------- | ---------------------------------------------------------------------------------------- |
| `--json`                | Print the result as JSON ([format](/docs/json)). Nothing else goes to stdout.             |
| `--markdown`            | Print the result as a pull request comment.                                               |
...
- **Terminal** (default): progress on stderr while it works (only in an interactive terminal),
  then the result on stdout. Colours when stdout is a terminal.
